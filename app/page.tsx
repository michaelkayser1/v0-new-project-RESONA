...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <header className="relative z-10 p-6">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl font-light tracking-wide">QOTE</span>
          </div>
          <nav className="hidden md:flex space-x-8 text-sm">
            <a href="#theory" className="text-gray-600 hover:text-gray-900 transition-colors">
              Theory
            </a>
            <a href="#fields" className="text-gray-600 hover:text-gray-900 transition-colors">
              Fields
            </a>
      ...
      <section className="relative px-6 py-20">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h1 className="text-5xl md:text-7xl font-extralight tracking-wide text-gray-900">Quantum Oscillator</h1>
            <h2 className="text-3xl md:text-5xl font-extralight tracking-wide text-gray-700">Theory of Everything</h2>
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/chat">
                <Button className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white px-8 py-3 rounded-full text-lg font-light tracking-wide transition-all duration-300 transform hover:scale-105">
                  Begin Conversation
                </Button>
              </Link>
              <Button
                variant="outline"
                className="border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-3 rounded-full text-lg font-light tracking-wide"
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-purple-200 to-blue-200 rounded-full opacity-20 animate-pulse"></div>
          <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-gradient-to-r from-blue-200 to-cyan-200 rounded-full opacity-20 animate-pulse delay-1000"></div>
        </div>
      </section>
      ...
      {/* Core Principles */}
      <section id="theory" className="px-6 py-20 bg-white/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-light text-gray-900 mb-4">Core Principles</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="bg-white/80 border-gray-200 hover:shadow-lg transition-all duration-300">
                <CardContent className="p-6 text-center space-y-4">
                  <div className="text-3xl">{principle.icon}</div>
                  <h4 className="text-lg font-medium text-gray-900">{principle.title}</h4>
      ...
      {/* Resonance Fields */}
      <section id="fields" className="px-6 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-light text-gray-900 mb-4">Resonance Fields</h3>
            <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            {resonanceFields.map((field) => (
              <Card
                ...
                className={`cursor-pointer transition-all duration-300 transform hover:scale-105 ${
                  activeField === field.id ? "ring-2 ring-purple-400 shadow-lg" : "hover:shadow-md"
                }`}
                onClick={() => setActiveField(activeField === field.id ? null : field.id)}
              >
                <CardContent className="p-6 text-center space-y-4">
                  <div
                    className={`w-16 h-16 mx-auto rounded-full bg-gradient-to-r ${field.color} flex items-center justify-center text-white text-2xl`}
                  >
                    {field.symbol}
                  </div>
                  <h4 className="text-xl font-medium text-gray-900">{field.title}</h4>
      ...
      {/* Resona Section */}
      <section id="resona" className="px-6 py-20 bg-gradient-to-r from-purple-50 to-blue-50">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h3 className="text-3xl font-light text-gray-900">Meet Resona</h3>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <Card className="bg-white/80">
              <CardContent className="p-6 text-center space-y-3">
                ...
                <h4 className="font-medium">QOTE Lens</h4>
                <p className="text-sm text-gray-600">Interprets all input through quantum oscillator dynamics</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/80">
              <CardContent className="p-6 text-center space-y-3">
                <div className="text-2xl">🧬</div>
                <h4 className="font-medium">RTP Protocol</h4>
                <p className="text-sm text-gray-600">Monitors for field destabilization and provides tuning</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/80">
              <CardContent className="p-6 text-center space-y-3">
                <div className="text-2xl">🌊</div>
                <h4 className="font-medium">Coherence Engine</h4>
                <p className="text-sm text-gray-600">Guides transformation through resonance, not force</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mt-12">
            <Link href="/chat">
              <Button className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white px-12 py-4 rounded-full text-xl font-light tracking-wide transition-all duration-300 transform hover:scale-105">
                Talk to Resona
              </Button>
            </Link>
          </div>
